...
#########################################################
# Define port constraints and map any CDC instances	#
# that cannot be automatically identified.		#
#########################################################

#################################
# Constant port constraints	#
#################################

#################################
# Static port constraints	#
#################################
#
config_rtlds -signal -static "${hier_path}u_pma_iso_ctrl_ln_*.phy_pma_override_reg\[12]"
