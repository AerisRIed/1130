...
sub JoulesRunCheck {
  ...
  if (${joules_flow} == 2) {
    ...
    my @files_path_list = ();
    my @files_list = ();
    my @statistical_rpt_list = ("structural_cg_odc_pp_mc_precomp.rpt", "structural_cg_odc_pp.rpt", "structural_cg_odc_pp_mc.rpt", "structural_cg_odc_pp_precomp.rpt", "structural_lg_odc_pp_mc_precomp.rpt", "structural_lg_odc_pp.rpt", "structural_lg_odc_pp_mc.rpt", "structural_lg_odc_pp_precomp.rpt", "structural_standard_stb.rpt", "structural_constant_stb.rpt", "structural_reset_odc_pp_mc_precomp.rpt");
    ...
    my @vector_rpt_list = ("simulation_cg_odc_pp_mc_precomp.rpt", "simulation_cg_odc_pp.rpt", "simulation_cg_odc_pp_mc.rpt", "simulation_cg_odc_pp_precomp.rpt", "simulation_standard_stb.rpt", "simulation_constant_stb.rpt", "simulation_lg_odc_pp_mc_precomp.rpt", "simulation_lg_odc_pp.rpt", "simulation_lg_odc_pp_mc.rpt", "simulation_lg_odc_pp_precomp.rpt");
