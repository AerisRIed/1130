...
## List modules not to be ungrouped - e.g. sync flop modules
   set NO_UNGROUP " *data_sync_synth* *reset_sync_synth* "


#  set PRESERVE_INST_LIST "*C_reset_sync* *C_data_sync* *C_spare* *dft_tp*"
  # set PRESERVE_INST_LIST "*u_and* *u_clk_gate* *u_clk_xor* *u_data_mux_synth* *u_clk_gating_and_synth* *u_clk_gating_cell_synth* *u_data_sync_synth* *u_reset_sync_synth* *u_clock_div*  *u_scan_mux_synth* *u_clock_mux_synth* *u_clk*synth*" 
   set PRESERVE_INST_LIST "*u_dont_touch*" 
## List of pre mapped modules not to be touched - e.g. hierarchical synthesis
  #set PRESERVE_PRE_MAPPED_SUB_LIST ""
set PRESERVE_TEST_POINT_NET   ""
# set PRESERVE_TEST_POINT_NET [ list "*dft_tp*" "*debug_calib_pd_bias_comp*"]

## Preserve List of modules - e.g. sync flop modules
set PRESERVE_LIST [list " *data_sync_synth* *reset_sync_synth* *clock_div*"]
...
## If set to "" then a port scanen will be created
  set SHIFT_ENABLE_PORT "rxda_cdrlf_scanen"
...
## Specify a list of all existing ports that are to be used as
## scan clock inputs
#Remove APB_PCLK due to ICG issues 
  set TEST_CLK_PORTS  {rxda_cdrlf_scanclk}
#  set TEST_CLK_PORTS  {scanclk_base_clk scanclk_cdrlf_clk scanclk_utmi_clk scanclk_ser_tx_clk scanclk_ser_rx_clk APB_PCLK tap_tck ieee1687_tck}
...
## active low test reset inputs
  set TEST_RSTN_PORTS {rxda_cdrlf_reset_n}
...
##This list should be space separated
  set RTL_SCAN_INS {rxda_cdrlf_scanin}
