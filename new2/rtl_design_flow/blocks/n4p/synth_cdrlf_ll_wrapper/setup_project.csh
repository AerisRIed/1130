...
################################################################################
  ...
  if (! $?STORK_DELIVERY) then 
    ...
    setenv DUT_PATH $PWD/../../../../
    setenv CFG_DIR "$DUT_PATH/rtl_design_flow/blocks/n4p/synth_${DESIGN}"
  else
...
################################################################################
  if (! $?STORK_DELIVERY) then
    setenv RTL_PATH $DUT_PATH/tag/rtl
  else
...
################################################################################
  ...
  set RTL_F_FILELIST = (/projects/sd3101_n4p/users/ynzhang/U4_repository/Timberwolf_USB4_T4GP/trunk/design/filelist/timberwolf_cdrlf_synth.f \
                     )
...
################################################################################
  setenv SDC_PATH  "/projects/sd3101_n4p/users/ynzhang/U4_repository/Timberwolf_USB4_T4GP/trunk/design/constraints/cdrlf/"
...
#setenv SPYGLASS_PACK_LOCATION $DUT_PATH/cfg/${CONFIG}/spyglass
 setenv SPYGLASS_PACK_LOCATION  $DUT_PATH/rtl_design_flow/blocks/n4p/synth_${DESIGN}/spyglass/
