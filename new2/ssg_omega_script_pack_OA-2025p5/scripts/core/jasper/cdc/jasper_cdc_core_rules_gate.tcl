...
// Jasper Gate-Level CDC Rule File
// Tool version: 2025.03p001 (4/23/2025)
// Adapted from: <jasper_install>/etc/res/rtlds/rules/cdc_gate_level.def
...
SIG_NO_STAT {severity=Error}   {msg="Signal '%s' is not static"} {status=off}
SIG_NO_GRAY {severity=Error}   {msg="Signal '%s' is not gray encoded"} {status=off}
SIG_NO_EXCL {severity=Error}   {msg="Signals '%s' are not mutually toggle exclusive"} {status=off}
CND_NO_CONS {severity=Error}   {msg="Signal '%s' is not constant"} {status=off}
...
SYN_DF_SLGC {severity=Error}   {msg="Combo Logic in NDFF synchronizer chain '%s' driven by clock '%s'"} {status=off}
SYN_DF_CKPH {severity=Error}   {msg="Different clock phases drive NDFF synchronizer '%s' clocked by '%s'"} {status=off}
SYN_DF_FOUT {severity=Error}   {msg="Multiple fanouts of first flop of NDFF scheme '%s' driven by clock '%s'"} {status=off}
...
CNV_ST_CONV {severity=Error} {msg="Convergence at '%s' in destination clock domain '%s' after synchronization"} {status=off}
...
MUX_ST_GLCH {severity=Error} {msg="Potential glitch at '%s' on mux scheme '%s' of type '%s'"}
}

category CDC_FUNCTIONAL // Category of CDC functional checks
{
CTL_NO_STBL {severity=Error} {msg="Control path '%s' is not stable long enough to be captured correctly by destination clock '%s'"} {status=off}
PLS_NO_STBL {severity=Error} {msg="Pulse input '%s' from source clock '%s' is not stable long enough to be captured by destination clock '%s'"} {status=off}
DAT_NO_STBL {severity=Error} {msg="Data Path '%s' is not stable long enough to be captured by destination clock '%s'"} {status=off}
REQ_NO_HOLD {severity=Error} {msg="Handshake request signal '%s' from source clock '%s' is de-asserted before acknowledgment is received from destination clock '%s'"} {status=off}
NRQ_WO_DACK {severity=Error} {msg="New handshake request is asserted by the handshake synchronizer '%s' from the source clock '%s' before the previous acknowledge is de-asserted from the destination clock '%s'"} {status=off}
ACK_WO_SREQ {severity=Error} {msg="Handshake acknowledge signal of handshake synchronizer '%s' from destination clock '%s' is de-asserted before request from source clock '%s' is de-asserted"} {status=off}
NAK_WO_SREQ {severity=Error} {msg="New handshake acknowledge is asserted by the handshake synchronizer '%s' from the destination clock '%s' before a new request is asserted from the source clock '%s'"} {status=off}
DAT_HS_STBL {severity=Error} {msg="Handshake data from source clock '%s' of handshake synchronizer '%s' changes before acknowledge is received from the destination clock '%s'"} {status=off}
PSH_ON_FULL {severity=Error} {msg="Write to FIFO '%s' from source clock '%s' is possible when full"} {status=off}
POP_ON_EMTY {severity=Error} {msg="Read from FIFO '%s' in destination clock '%s' is possible when empty"} {status=off}
GET_NO_STBL {severity=Error} {msg="Signal '%s' controlling the read cycle of the FIFO is not stable long enough for its effect to be captured properly in the write domain by clock '%s'"} {status=off}
PUT_NO_STBL {severity=Error} {msg="Signal '%s' controlling the write cycle of the FIFO is not stable long enough for its effect to be captured properly in the read domain by clock '%s'"} {status=off}
GPD_NO_STBL {severity=Error} {msg="Glitch protector data path '%s' is not stable when enable signal '%s' is asserted in destination clock '%s'"} {status=off}
SYN_NO_STBL {severity=Error} {msg="Sync enabler data path '%s' is not stable when enable signal '%s' is asserted in destination clock '%s'"} {status=off}
INC_FN_PROP {severity=Error} {msg="Incomplete scheme property generated for synchronizer '%s' in destination clock '%s'"} {status=off}
USR_FN_PROP {severity=Error} {msg="User defined scheme property '%s' failed for synchronizer '%s'"} {status=off}
}

category CDC_METASTABILITY // Category of CDC metastability checks
{
CHK_MS_FAIL {severity=Error} {msg="User property '%s' failed due to metastability injection"} {status=off}
INJ_MS_FAIL {severity=Error} {msg="Injection failure: CDC destination unit '%s' could not be made metastability-aware due to the presence of a previous abstraction"} {status=off}
}
...
SYN_RS_CKPH {severity=Error}   {msg="The flops of reset synchronizer '%s' are driven by different phases of the clock '%s'"} {status=off}
SYN_RS_SMDR {severity=Error}   {msg="The flops of reset synchronizer '%s' are not driven by same reset signal"} {status=off}
SYN_RS_SLGC {severity=Error}   {msg="Combo logic exists between flops of reset synchronizer '%s'"} {status=off}
SYN_RS_RDND {severity=Warning} {msg="Redundant reset synchronizer on reset path between source clock '%s' to destination clock '%s'"} {status=off}
...
// Valid values: True | False
// Default value: False
params CDC_APP {strict_ndff_detection="False"}
...
// trying to cover unsynchronized pairs after all composite schemes has been detected
// Valid values: True | False
// Default value: False
...
// Valid values: True | False
// Default value: False
params RDC {strict_reset_scheme_detection="False"}
...
// Specifies if RST_RS_CONV violations should be reported when the same net drives all the
