...
set reset_init_file [dict create]
set xprop_src_targ [dict create]
...
set common_user_reset_sequence_file      "$prl_script_root_dir/../../../user/jasper/common/jasper_common_user_reset_sequence.tcl"
set common_user_attributes_file          "$prl_script_root_dir/../../../user/jasper/common/jasper_common_user_attributes.tcl"
...
set xprop_core_message_settings_file     "$prl_script_root_dir/../xprop/jasper_xprop_core_message_settings.tcl"
set xprop_user_assertion_file            "$prl_script_root_dir/../../../user/jasper/xprop/jasper_xprop_user_assert_assume.tcl"
set xprop_user_rule_waivers_file         "$prl_script_root_dir/../../../user/jasper/xprop/jasper_xprop_user_rule_waivers.tcl"
set xprop_user_message_settings_file     "$prl_script_root_dir/../../../user/jasper/xprop/jasper_xprop_user_message_settings.tcl"
...
foreach cif [list $global_tcl_utils_file $global_command_merge_file $common_core_utils_file $common_core_message_settings_file \
		  ...
		  $common_user_reset_sequence_file $common_user_attributes_file $cdc_core_rule_waivers_file $cdc_core_message_settings_file \
		  $cdc_core_rtl_rules_file $cdc_core_gate_rules_file $cdc_core_rule_settings_file $cdc_user_rule_waivers_file \
		  $cdc_user_message_settings_file $cdc_user_constraints_file $cdc_user_rule_settings_file $superlint_core_rules_file \
		  $superlint_core_message_settings_file $superlint_core_rule_settings_file $superlint_core_rule_waivers_file \
		  $superlint_user_constraints_file $superlint_user_message_settings_file $superlint_user_rule_settings_file \
		  $superlint_user_rule_waivers_file $mcp_core_message_settings_file $mcp_user_constraints_file $mcp_user_message_settings_file \
		  $mcp_user_rule_waivers_file $xprop_core_message_settings_file $xprop_user_assertion_file $xprop_user_rule_waivers_file \
		  $xprop_user_message_settings_file] {
...
if {$prl_generate_reports} {
  ...
  if {$prl_run_cdc} {
    ...
    CETFE_jg_xprop_report_collateral
  }
}
