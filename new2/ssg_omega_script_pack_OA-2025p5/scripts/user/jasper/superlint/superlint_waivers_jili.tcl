...
#pma rx
check_superlint -waiver -add  -module xcvr_txonly  -tag CLK_NO_INPT  -comment {Original clock design from Whistler/torrent}
check_superlint -waiver -add  -module xcvr_txrxm   -tag CLK_NO_INPT  -comment {Original clock design from Whistler/torrent}
check_superlint -waiver -add  -module xcvr_clkrst  -tag CLK_NO_INPT  -comment {Original clock design from Whistler/torrent}
check_superlint -waiver -add  -module xcvr_ctrl    -tag RST_IS_DCMB  -comment {Original clock design from Whistler/torrent, reset will be sync after combination logics}
check_superlint -waiver -add  -module xcvr_clkrst  -tag RST_IS_DCMB  -comment {Original clock design from Whistler/torrent, reset will be sync after combination logics}
...
check_superlint -waiver -add  -module tx_coef_calc_cdb_regs -tag WIR_NO_READ  -comment {unused register field or readonly register not need to write}
check_superlint -waiver -add  -module tx_coef_calc -tag WIR_NO_READ  -comment {unused register field or readonly register not need to write}
check_superlint -waiver -add  -module cdnsdru_power_sm_v4_cdb_regs -tag WIR_NO_READ  -comment {unused register field or readonly register not need to write}
check_superlint -waiver -add  -module drv_ctrl_diag_ovrd -tag WIR_NO_READ  -comment {unused register field or readonly register not need to write}
