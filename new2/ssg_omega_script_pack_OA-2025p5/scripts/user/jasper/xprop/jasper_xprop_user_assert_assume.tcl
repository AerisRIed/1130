...
#########################################################
# Use any of the "assert", "assume", "abstract", or	#
# "stopat" commands to configure the design for formal	#
# XPROP analysis. This file is sourced immediately	#
# after signal binding and reset definition.		#
#########################################################
